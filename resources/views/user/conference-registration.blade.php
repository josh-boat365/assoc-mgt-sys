<x-app-layout>
    ...
    <h2 class=" text-[2rem] text-center">Invoice Details - Conference Registration</h2>
                    ...
                    <div class="relative overflow-x-auto border p-4 max-w-2xl m-auto rounded border-gray-200">
                        ...
                        <form id="paymentForm" action="#" method="post">
                            ...
                            <div class="mt-5 relative float-right">
                                ...
                                <x-green-button class="ml-4" onclick="payWithPaystack(event)"> {{ __('Register for Conference') }} </x-green-button>
