<x-app-layout>
    ...
    <div class="mt-5 md:container md:mx-auto">
        <div class="text-center">
            ...
            @forelse ($AuthUser as $user )
            <span class="text-[1.6rem]">{{$user->firstname}} {{$user->surname}}</span>
            @empty
        ...
        <div class="py-12">
            <div class="max-w-5xl md:mx-auto sm:px-6 lg:px-8">
                <div class="flex flex-wrap justify-center p-3 gap-5">
                    <x-card href="{{ route('profile.edit')}}" class="w-[12rem] text-center border-t-4 rounded border-sky-700">
