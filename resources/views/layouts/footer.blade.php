<footer class=" sm:flex sm:items-center sm:justify-between p-2 sm:p-6 xl:p-8 dark:bg-gray-800">
  <p class="mb-4 m-auto text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
      &copy; 2023 - <script> document.write(new Date().getFullYear())</script> <a href="https://integrisgh.com/" class="hover:underline" target="_blank">integrisgh.com</a>. All rights reserved.
  </p>
